<div class="panel register--personal">
    <h2 class="panel--title jj--headline-center">{if isset($fieldset_title) && !empty($fieldset_title)}{$fieldset_title}{else}{s name='RegisterPersonalMarketingHeadline'}{/s}{/if}</h2>
