...
/*var stickyElement   = '.product--buybox',   // the element you want to make sticky
    bottomElement   = '.tab-menu--cross-selling'; // the bottom element where you want the sticky element to stop (usually the footer) 
